...
def datetime_convert(time):
    """
    Convertis time sous la forme YYYY-MM-DD HH:MM:SS
    """
    _time = str(time)
...
def date_convert(date):
    """
    Convertis date sous la forme YYYY-MM-DD
    """
    _date = str(date)
...
def time_convert(time):
    """
    Convertis time sous la forme HH:MM:SS
    """
    _time = str(time)
    retime = re.compile(r'\W+')
    _list = retime.split(_time)
...
def add_time(time, retard):
    """
    Ajout du temps sur le temps en cours
    """
